...
fun LineCustomizationLineChartExample() {
    ...
    var pointsRadiusText by remember { mutableStateOf("5") }
    val pointsRadius by remember(pointsRadiusText) {
        mutableFloatStateOf(
            with(density) {
    ...
    var blueLineCornerRadiusText by remember { mutableStateOf("5") }
    ...
    var showBlueLineFill by remember { mutableStateOf(true) }
    ...
    var redLineDashLengthText by remember { mutableStateOf("10") }
    var redLineDashSpaceLengthText by remember { mutableStateOf("15") }
    ...
    var showRedLineFill by remember { mutableStateOf(true) }
