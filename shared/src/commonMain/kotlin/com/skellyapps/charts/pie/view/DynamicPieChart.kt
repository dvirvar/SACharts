...
fun DynamicPieChart(
    ...
    Canvas(modifier) {
        ...
        if (hasLabels) {
            ...
            data.slices.forEach { slice ->
                ...
                if (slice.label != null) {
                    ...
                    val horizontalOverhead = shoulder + textPadding + textWidth + (extensionMax * abs(cosVal))
        ...
        fun drawLabel(label: String, labelCustomization: PieChartData.LabelCustomization, middleRad: Double) {
            ...
            val lineToTextPadding = labelCustomization.lineCustomization.lineToTextPadding.toPx()
            ...
            val textX = if (isRightSide) finalLineEndX + lineToTextPadding else finalLineEndX - textWidth - lineToTextPadding
        ...
        if (data.slices.size == 1) {
            ...
            drawOnEachSlice?.let { it(this, slice.tag, centerX, centerY, outerRadius, innerRadius, middleRad) }
