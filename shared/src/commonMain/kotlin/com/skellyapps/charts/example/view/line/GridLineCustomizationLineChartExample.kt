...
fun GridLineCustomizationLineChartExample() {
    ...
    var showLeftAxisGrid by retain { mutableStateOf(true) }
    ...
    var leftAxisGridDashLengthText by retain { mutableStateOf("10") }
    var leftAxisGridDashSpaceLengthText by retain { mutableStateOf("15") }
    ...
    var showRightAxisGrid by retain { mutableStateOf(false) }
    ...
    var showBottomAxisGrid by retain { mutableStateOf(true) }
                ...
                Row(verticalAlignment = Alignment.Bottom) {
                    ...
                    if (showLeftAxisGrid) {
                        OutlinedTextField(
                            ...
                            Modifier.arrowValueStepper(leftAxisGridDashLengthText, 10f) {
                                leftAxisGridDashLengthText = it
                            },
                        ...
                        OutlinedTextField(
                            ...
                            Modifier.arrowValueStepper(leftAxisGridDashSpaceLengthText, 15f) {
                                leftAxisGridDashSpaceLengthText = it
                            },
