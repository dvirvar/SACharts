...
fun DividerCustomizationLineChartExample() {
    ...
    var showLeftAxisDivider by retain { mutableStateOf(true) }
    ...
    var leftAxisDividerDashLengthText by retain { mutableStateOf("10") }
    var leftAxisDividerDashSpaceLengthText by retain { mutableStateOf("15") }
    ...
    var showRightAxisDivider by retain { mutableStateOf(false) }
    ...
    var showBottomAxisDivider by retain { mutableStateOf(true) }
